USE [MotorIns]
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_DomesticBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_DomesticInsSave]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_IndividualBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_IndividualInsSave]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_MotorBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_MotorInsSave]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_NewInsBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_NewInsSave]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_TravelBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[UDT_TravelInsSave]    Script Date: 04-04-2021 21:27:26 ******/
...
GO
/****** Object:  Table [dbo].[TB_Calender]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[TB_Domestic]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TB_Individual]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TB_Insurance]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[TB_Insurance](
	...
	[ExpiredSumInsured] [decimal](18, 2) NULL
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[TB_Motor]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TB_ProducerCodeMaster]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TB_RoleMaster]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TB_Travel]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TB_Users]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[pBulkDelegateStatus]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[pBulkUpdateInsuranceStatus]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[pBulkUploadInsurance]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET @ErrorMsg =''
	...
	WITH (
			...
			DivisionCode nvarchar(250) N'$.DivisionCode',
DivisionName nvarchar(250) N'$.DivisionName',
ProductCode nvarchar(250) N'$.ProductCode',
ProductName nvarchar(250) N'$.ProductName',
CustomerType nvarchar(250) N'$.CustomerType',
PolicyNo nvarchar(250) N'$.PolicyNo',
AssuredName nvarchar(250) N'$.AssuredName',
CustomerMobile nvarchar(250) N'$.CustomerMobile',
CustomerName nvarchar(250) N'$.CustomerName',
SourceCode nvarchar(250) N'$.SourceCode',
SourceName nvarchar(250) N'$.SourceName',
CustomerCategory nvarchar(250) N'$.CustomerCategory',
PolicyFromDate datetime N'$.PolicyFromDate',
PolicyToDate datetime N'$.PolicyToDate',
GrossPremium bigint N'$.GrossPremium',
ExpiredSumInsured bigint N'$.ExpiredSumInsured',
RenewalPremium bigint N'$.RenewalPremium',
MarketingExecutive nvarchar(250) N'$.MarketingExecutive',
Remarks nvarchar(250) N'$.Remarks',
Status nvarchar(250) N'$.Status',
CustomerCode nvarchar(250) N'$.CustomerCode',
Charges bigint N'$.Charges',
UserName nvarchar(250) N'$.UserName'
            ...
            INSERT INTO TB_Insurance
                        (DivisionCode,DivisionName,ProductCode,ProductName,InsType,PolicyNo,AssuredName,AssuredMobile,CustomerName,SourceCode,
SourceName,CustomerCategory,PolicyFromDate,PolicyToDate,GrossPremium,ExpiredSumInsured,RenewalPremium,MarketingExecutive,
Remarks,Status,CustomerCode,Charges,Producer,EntryType,CreatedBy) 
            

		SELECT	DivisionCode,DivisionName,ProductCode,ProductName,CustomerType,PolicyNo,AssuredName,CustomerMobile,CustomerName,SourceCode,
SourceName,CustomerCategory,PolicyFromDate,PolicyToDate,GrossPremium,ExpiredSumInsured,RenewalPremium,MarketingExecutive,
Remarks,Status,CustomerCode,Charges,UserName,'Bulk Upload',@UserName FROM #TempInsurance where PolicyNo not in (select distinct PolicyNo from TB_Insurance)
...
GO
/****** Object:  StoredProcedure [dbo].[pGetDelegateData]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[PGetSearchMasterMotor]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	...
	BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					SET @Where = ' CONVERT(date, PolicyFromDate) BETWEEN '''+@FromDate+''' AND '''+ @ToDate+''' '
				END
...
ELSE
  BEGIN 
	...
	BEGIN
		...
		SET @Where = @Where + ' AND CONVERT(date, PolicyFromDate) BETWEEN '''+@FromDate+''' AND '''+ @ToDate+''' '
	END
...
GO
/****** Object:  StoredProcedure [dbo].[pGetUserAutoComplete]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_DomesticBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetBarChart]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
right join TB_Calender C on C.MonthName=DATENAME(month, PolicyToDate) and year(getdate())=year(PolicyToDate)  where Producer=@UserName and InsType='Motor') t
pivot
(Count (PolicyNo) for Status in([Lost],[Renewed],[Under process])) as pivot_final_table order by CalenderId
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetBIDashBoard]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
select distinct DivnCode, divisionname from TB_Insurance order by DivnCode
...
inner join @divisionMaster dm on  dm.DivisionName=m.DivisionName
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetBIDashBoard_bak]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetBIDashBoardYearWise]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
pivot
(Count (PolicyNo) for Status in([Lost],[Renewed],[Under Process])) as pivot_final_table order by YEAR
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GetCallBackDetails]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetInsurance]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_GetMastersView]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Isnull(CallBackDate ,GETDATE()) as CallBackDate,ExpiredSumInsured
From TB_Insurance order by InsuranceID desc
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetMIDashBoard]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetPMDashBoard]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetProducerMaster]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetSearch]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetSpecificBIDB]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserDomesticDB]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserIndividualDB]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserInsInfo]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
set @TotalNoPoliciesYearPremium =(SELECT sum(ExpiredSumInsured) from TB_Insurance where year(getdate())=year(PolicyToDate))
set @TotalNoPolUnderProcessYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where year(getdate())=year(PolicyToDate) and Status='Under Process')
set @TotNoPolLostYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where year(getdate())=year(PolicyToDate) and Status='Lost')
set @TotalNoPolRenewedYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where year(getdate())=year(PolicyToDate) and Status='Renewed')
...
set @TotalNoPoliciesMonthPremium=(select sum(ExpiredSumInsured) from TB_Insurance where year(getdate())=year(PolicyToDate) and month(getdate())=month(PolicyToDate))
set @TotalNoPoliciesLostMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where status='Lost' and year(getdate())=year(PolicyToDate) and month(getdate())=month(PolicyToDate))
set @TotalNoPoliciesUPMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where status='Under Process' and year(getdate())=year(PolicyToDate) and month(getdate())=month(PolicyToDate))
set @TotalNoPoliciesRenewedMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where status='Renewed' and year(getdate())=year(PolicyToDate) and month(getdate())=month(PolicyToDate))
...
set @TotalNoPoliciesYearPremium =(SELECT sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1))
set @TotalNoPolUnderProcessYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  Producer=@UserName and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Under Process')
set @TotNoPolLostYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and  PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Lost')
set @TotalNoPolRenewedYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  Producer=@UserName and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Renewed')
...
set @TotalNoPoliciesMonthPremium=(select sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and  PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesLostMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and  status='Lost' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesUPMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  Producer=@UserName and status='Under Process' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesRenewedMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and  status='Renewed' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserInsInfo_bak]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserList]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserMDB]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
set @TotalNoPoliciesYearPremium =(SELECT sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1))
set @TotalNoPolUnderProcessYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Under Process')
set @TotNoPolLostYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  InsType='Motor' and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Lost')
set @TotalNoPolRenewedYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  InsType='Motor' and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Renewed')
if(@TotalNoPolRenewedYearPremium>0 and @TotalNoPoliciesYearPremium>0) 
begin
set @TotalNPYearPercentPremium= (@TotalNoPolRenewedYearPremium*100/ @TotalNoPoliciesYearPremium )
end
...
set @TotalNoPoliciesMonthPremium=(select sum(ExpiredSumInsured) from TB_Insurance where  InsType='Motor' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesLostMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  InsType='Motor' and status='Lost' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesUPMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  InsType='Motor' and status='Under Process' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesRenewedMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and  status='Renewed' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
...
set @TotalNoPoliciesYearPremium =(SELECT sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and Producer=@UserName and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1))
set @TotalNoPolUnderProcessYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and  Producer=@UserName and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Under Process')
set @TotNoPolLostYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and Producer=@UserName and  PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Lost')
set @TotalNoPolRenewedYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and  Producer=@UserName and PolicyToDate between  DATEADD(yy, DATEDIFF(yy, 0, GETDATE()), 0) and    DATEADD(yy, DATEDIFF(yy, 0, GETDATE()) + 1, -1) and Status='Renewed')
...
set @TotalNoPoliciesMonthPremium=(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and Producer=@UserName and  PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesLostMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and Producer=@UserName and  status='Lost' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesUPMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and  Producer=@UserName and status='Under Process' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesRenewedMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where InsType='Motor' and Producer=@UserName and  status='Renewed' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserTravelDB]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserwiseInfo]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetUserwiseReport]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GetYearwisePolicyReport]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
set @TotalNoPoliciesYearPremium =(SELECT sum(ExpiredSumInsured) from TB_Insurance where datepart(year, PolicyToDate)=@Year)
set @TotalNoPolUnderProcessYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where datepart(year, PolicyToDate)=@Year and Status='Under Process')
set @TotNoPolLostYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where datepart(year, PolicyToDate)=@Year and Status='Lost')
set @TotalNoPolRenewedYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where datepart(year, PolicyToDate)=@Year and Status='Renewed')
...
set @TotalNoPoliciesMonthPremium=(select sum(ExpiredSumInsured) from TB_Insurance where PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesLostMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where status='Lost' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesUPMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where status='Under Process' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
set @TotalNoPoliciesRenewedMonthPremium =(select sum(ExpiredSumInsured) from TB_Insurance where status='Renewed' and PolicyToDate between  DATEADD(MM, DATEDIFF(mm, 0, GETDATE()), 0) and DATEADD(mm, DATEDIFF(mm, 0, GETDATE()) + 1, -1))
...
set @TotalNoPoliciesYearPremium =(SELECT sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and datepart(year, PolicyToDate)=@Year)
set @TotalNoPolUnderProcessYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  Producer=@UserName and datepart(year, PolicyToDate)=@Year and Status='Under Process')
set @TotNoPolLostYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where Producer=@UserName and  datepart(year, PolicyToDate)=@Year and Status='Lost')
set @TotalNoPolRenewedYearPremium =(select sum(ExpiredSumInsured) from TB_Insurance where  Producer=@UserName and datepart(year, PolicyToDate)=@Year and Status='Renewed')
...
GO
/****** Object:  StoredProcedure [dbo].[SP_IndividualBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_InsBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CustomerCategory,PolicyFromDate,PolicyToDate,GrossPremium,ExpiredSumInsured,RenewalPremium,MarketingExecutive,Remarks,Status,CustomerCode,Charges,
...
GO
/****** Object:  StoredProcedure [dbo].[SP_InsUpdate]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_MotorBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_MotorDomesticSave]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
M.Email=UDT.Email
  ...
  END 
GO
/****** Object:  StoredProcedure [dbo].[SP_MotorIndividualSave]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
M.AppointeeCivilIDNo=UDT.AppointeeCivilIDNo
  ...
  END 
GO
/****** Object:  StoredProcedure [dbo].[SP_MotorInsSave]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ELSE
  ...
  END 
GO
/****** Object:  StoredProcedure [dbo].[SP_MotorInsUpdate]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_MotorTravelSave]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ELSE
  ...
  END 
GO
/****** Object:  StoredProcedure [dbo].[SP_NewInsSave]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
PolicyToDate,GrossPremium,RevisedSumInsured,RenewalPremium,MarketingExecutive,Remarks,DivisionCode,CustomerCode,Charges,Status,InsType,ProducerName,@UserName,'Single Data Entry'
  ...
  END 
GO
/****** Object:  StoredProcedure [dbo].[SP_NewInsUpdate]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
M.Producer=UDT.ProducerName,
        ...
        END 
GO
/****** Object:  StoredProcedure [dbo].[SP_RegisterUser]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_TravelBulkUpload]    Script Date: 04-04-2021 21:27:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

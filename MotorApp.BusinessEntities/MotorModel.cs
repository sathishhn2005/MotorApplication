...
namespace MotorApp.BusinessEntities
{
    public class MotorModel
    {
        ...
        public string PolicyNumberifRenewal { get; set; }
        ...
        public string AgencyRepair { get; set; }

        public string VehicleInformations { get; set; }
        ...
        public string Hirepurchase_BankName { get; set; }
        ...
        public string NillAdditionalDriver { get; set; }
